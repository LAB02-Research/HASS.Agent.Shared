...
using HASS.Agent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.MultiValue.DataTypes;
using Serilog;

namespace HASS.Agent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.MultiValue
{
    /// <summary>
