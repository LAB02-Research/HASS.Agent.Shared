...
using HASSAgent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.MultiValue.DataTypes;
using HASSAgent.Shared.Models.Internal;
using Newtonsoft.Json;
using Serilog;

namespace HASSAgent.Shared.Models.HomeAssistant.Sensors.GeneralSensors.MultiValue
{
    /// <summary>
